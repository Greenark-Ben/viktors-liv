...
export function StudioDashboard({navigate}:Props){
 ...
 const cards=useMemo(()=>[
  ...
  {id:'journey' as const,n:'05',title:'Tidslinje',count:count('viktors-liv.journey.v1'),unit:'livshändelser',copy:'Underhåll de händelser som formar Viktors berättelse.',state:'Arbetsyta redo'},
