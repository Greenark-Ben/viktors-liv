...
export function ObservationPanel(){
 ...
 useEffect(()=>{const refresh=()=>setStories(readStories());window.addEventListener('storage',refresh);window.addEventListener('liv:daily-stories-changed',refresh as EventListener);return()=>{window.removeEventListener('storage',refresh);window.removeEventListener('liv:daily-stories-changed',refresh as EventListener)}},[]);
